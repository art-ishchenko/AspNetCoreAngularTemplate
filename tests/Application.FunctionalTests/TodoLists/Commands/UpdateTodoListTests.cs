...
using AspNetCoreAngularTemplate.Application.TodoLists.Commands.CreateTodoList;
using AspNetCoreAngularTemplate.Application.TodoLists.Commands.UpdateTodoList;
using AspNetCoreAngularTemplate.Domain.Entities;

namespace AspNetCoreAngularTemplate.Application.FunctionalTests.TodoLists.Commands;
...
public class UpdateTodoListTests : BaseTestFixture
{
    ...
    public async Task ShouldRequireUniqueTitle()
    {
        ...
        (await FluentActions.Invoking(() =>
            SendAsync(command))
                .Should().ThrowAsync<AppValidationException>().Where(ex => ex.Errors.ContainsKey("Title")))
