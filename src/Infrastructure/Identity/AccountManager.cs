...
namespace AspNetCoreAngularTemplate.Infrastructure.Identity
{
    public class AccountManager : IAccountManager
    {
        ...
        public async Task<(Result Result, string UserId)> CreateUserAsync(string email, string password)
        {
            ...
            // UNCOMMENT TO ASSIGN ROLES AFTER USER CREATED
            // try
            // {
        ...
        public async Task<Result> ConfirmEmailAsync(string userId, string confirmationCode)
        {
            if (confirmationCode.Contains(" "))
                confirmationCode = confirmationCode.Replace(" ", "+"); // "+" in token was incorrectly UrlDecoded along the way into a space. So replace back with a plus
